...
} from '../backend/lockfile.js';
import { writeFileSync, mkdirSync as _mkdirSync, rmSync as _rmSync } from 'fs';
...
test('lockfile: generateLockfileReport computes risk score with findings', async () => {
  const data = {
    packages: [
      { name: 'reakt', version: '1.0.0', peerDeps: {}, dependencies: {}, optionalDependencies: {} },
    ],
    root: {
      name: 'root',
      version: '1.0.0',
